...
function LoginFallback() {
  return (
    <div className="mx-4 my-12 w-full max-w-md rounded-2xl border border-slate-200/80 bg-white px-6 py-10 shadow-sm sm:mx-auto sm:max-w-lg sm:px-8 dark:border-slate-700 dark:bg-slate-900">
